...
export class NameLanguageDetectorController {
  constructor(
    private readonly nameLanguageDetectorService: NameLanguageDetectorService,
  ) {}

  @Post()
  create(@Body() createNameLanguageDetectorDto: CreateNameLanguageDetectorDto) {
    return this.nameLanguageDetectorService.create(
  ...
  update(
    @Param('id') id: string,
    @Body() updateNameLanguageDetectorDto: UpdateNameLanguageDetectorDto,
  ) {
    return this.nameLanguageDetectorService.update(
      +id,
      updateNameLanguageDetectorDto,
    );
  }
