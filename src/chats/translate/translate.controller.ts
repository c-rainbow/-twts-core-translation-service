...
export class ChatTranslateController {
  ...
  translate(@Body() dto: TranslateFragmentsDto) {
    return this.translateService.translate(dto.fragments, dto.srcLang, dto.config);
  }
  ...
  translate2() {
    const fragments: ChatFragment[] = [
      ...
      {"type":"emote","text":"Clap","emote":{
        "provider":"7tv","id":"603cb71c73d7a5001441f995","name":"Clap","url":"https://cdn.7tv.app/emote/603cb71c73d7a5001441f995/1x"}
      },
      {"type":"text","text":"이건 한글 번역 테스트용이에요"},
      {"type":"link","text":"https://www.google.com"},
      {"type":"text","text":"ㅇㅇ"}]
    return this.translateService.translate(fragments, 'auto', {defaultTargetLang: 'en'});
  }
