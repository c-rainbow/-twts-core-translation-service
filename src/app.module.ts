...
@Module({
  imports: [TranslationsModule, FragmentsTranslatorModule, FragmentsClassifierModule, NameLanguageDetectorModule, NameTranslatorModule, PronunciationsModule, EmotesModule, GoogleTranslateModule, PapagoTranslateModule],
